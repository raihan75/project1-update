...
namespace SmallBusinessManagementSystem.Repository
{
    public class ProductRepository
    {
        ...
        private void GetConnectionRepository()
        {
            conn = _connectionRepository.GetConnectionString();
        }
        ...
        public bool Save(ProductModel productModel)
        {
                ...
                VALUES('" + productModel.Code + "','" + productModel.Name + "', (SELECT Code FROM Category WHERE Name='" + productModel.Category + "'), " + productModel.ReorderLevel + ", '" + productModel.Description + "') ";
